...
function cleanupLegacySystray({ silent = false } = {}) {
  // 1) Runtime dir: ~/.9router-v2/runtime/node_modules/systray (or %APPDATA% on Win)
  // 2) npm global nested: <npm_prefix>/node_modules/@zcus0/9router-v2/node_modules/systray
