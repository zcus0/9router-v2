...
Options:
  ...
  --api-key <key>         9router API key (or env NINE_ROUTER_V2_API_KEY)
...
function parseArgs(argv) {
  const opts = {
    ...
    port: DEFAULT_PORT,
    host: DEFAULT_HOST,
    apiKey: process.env.NINE_ROUTER_V2_API_KEY || null,
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-9router-v2-connection-id"] || null;
