...
🎉 Le tableau de bord s'ouvre sur `http://localhost:20135`
...
- Tableau de bord : `http://localhost:20135/dashboard`
- API compatible OpenAI : `http://localhost:20135/v1`
...
| `PORT`                                               | défaut du framework                         | Port du service (`20135` dans les exemples)                                                   |
...
| `BASE_URL`                                           | `http://localhost:20135`                    | URL de base interne côté serveur utilisée par les tâches de synchronisation cloud             |
...
- Définissez `PORT=20135` et `NEXT_PUBLIC_BASE_URL=http://localhost:20135`
