...
🎉 O painel abre em `http://localhost:20135`
...
- Painel: `http://localhost:20135/dashboard`
- API compatível com OpenAI: `http://localhost:20135/v1`
...
| `PORT` | padrão da estrutura | Porta de serviço (`20135` nos exemplos) |
...
| `BASE_URL` | `http://localhost:20135` | URL base interna do lado do servidor usada por trabalhos de sincronização na nuvem |
...
- Definir `PORT=20135` e `NEXT_PUBLIC_BASE_URL=http://localhost:20135`
